...
function G.setup_keymaps()
  ...
  vim.keymap.set("n", "<S-Tab>", "vsnip#jumpable(-1) ? '<Plug>(vsnip-jump-prev)'      : '<S-Tab>'", {expr = true})
  ...
  vim.keymap.set("n", "<leader>dB", "<cmd>lua require'dap'.list_breakpoints()<CR><cmd>lua require('telescope.builtin').quickfix()<CR>", opts)
